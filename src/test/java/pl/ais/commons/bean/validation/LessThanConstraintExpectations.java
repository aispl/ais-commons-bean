...
/**
 * Verifies {@link Constraints#lessThan(Comparable)} expectations.
 *
 * @author Warlock, AIS.PL
 * @since 1.4.1
 */
@RunWith(Parameterized.class)
public class LessThanConstraintExpectations {
    ...
    public <T extends Comparable<T>> LessThanConstraintExpectations(final String description,
                                                                    final T candidate, final T boundary,
                                                                    final boolean satisfied) {
        this.candidate = candidate;
        constraint = lessThan(boundary);
